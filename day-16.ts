type FindSantaRow<T extends string[], U extends any[] = []> = T extends [
  infer Head,
  ...infer Rest extends string[]
]
  ? Head extends "🎅🏼"
    ? U["length"]
    : FindSantaRow<[...Rest], [...U, unknown]>
  : false;

type FindSanta<T extends string[][], U extends any[] = []> = T extends [
  ...any[]
]
  ? FindSantaRow<T[U["length"]]> extends infer Row extends number
    ? [U["length"], Row]
    : FindSanta<T, [...U, unknown]>
  : never;
