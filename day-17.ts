...
// type WhoWins<T extends RockPaperScissors, U extends RockPaperScissors> = T extends U ? 'draw': U extends '👊🏻' ? T extends '🖐🏾' ? 'lose' : 'win' : U extends '🖐🏾' ? T extends '✌🏽' ? 'lose' : 'win' : U extends '✌🏽' ? T extends '👊🏻' ? 'lose' : 'win' : never
type WhoWins<
  T extends RockPaperScissors,
  U extends RockPaperScissors
> = Wins[T] extends Wins[U] ? "draw" : Wins[U] extends T ? "win" : "lose";
